...
/// A basis function \f$\phi_p: \mathcal{D} \mapsto \mathbb{R}\f$ such that \f$\langle \phi_p, \phi_q \rangle_{\mathcal{D}} = 1\f$ if \f$p=q\f$ and \f$0\f$ otherwise. 
/**
This class implements an orgothonal basis function \f$\phi_p: \Omega \mapsto \mathbb{R}\f$ such that
\f{equation*}{
   \langle \phi_p, \phi_q \rangle_{\mathcal{D}} = \int_{\mathcal{D}} \phi_p \phi_q \, dx = \begin{cases}
   1 & \text{if } p=q \\
   0 & \text{else,}
   \end{cases}
\f}
