...
void clf::python::ConservationLawWeakFormResidualWrapper(pybind11::module& mod) {
  py::class_<ConservationLawWeakFormResidual, std::shared_ptr<ConservationLawWeakFormResidual>, Residual, DensePenaltyFunction> resid(mod, "ConservationLawWeakFormResidual");
